...
import uk.gov.hmrc.disaaccountstubs.controllers.routes.EmailVerificationController
...
class EmailVerificationControllerSpec extends BaseUnitSpec {
  ...
  private val sendCodeUrl   = EmailVerificationController.sendCode().url
  private val verifyCodeUrl = EmailVerificationController.verifyCode().url
